  ...
  return (
    <div className="min-h-screen bg-[#0b0d0b] text-zinc-100">
      ...
      <header className="sticky top-0 z-30 border-b border-zinc-800/80 bg-[#0b0d0b]/85 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 md:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-6 text-sm text-zinc-400 lg:flex">
            <a href="#funkcje" className="hover:text-amber-400">
              Funkcje
            </a>
            <a href="#jak-dziala" className="hover:text-amber-400">
              Jak to działa
            </a>
            <a href="#cennik" className="hover:text-amber-400">
              Cennik
            </a>
      ...
      <main className="relative">
          ...
          <div className="mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-24 lg:px-8">
            ...
            >
              ...
              <p className="mt-6 max-w-3xl text-lg leading-8 text-zinc-400 md:text-xl">
                Profesjonalna strona główna, która buduje klimat, pokazuje przewagę
                operacyjną systemu i prowadzi właściciela strzelnicy do demo, wyboru
                planu oraz wdrożenia.
              </p>
              ...
              <div className="mt-10 grid w-full max-w-4xl gap-4 sm:grid-cols-3">
                {[
                  ...
                  <div
                    key={value}
                    className="rounded-3xl border border-zinc-800 bg-zinc-900/70 p-5 text-center shadow-[0_0_30px_rgba(0,0,0,0.25)]"
                  >
        ...
        <section className="border-b border-zinc-900 bg-[#0d100d]">
          <div className="mx-auto grid max-w-7xl gap-5 px-4 py-6 md:px-6 lg:grid-cols-4 lg:px-8">
            {[
              {
                icon: Lock,
                label: "Bezpieczna architektura",
                value: "Role, uprawnienia, separacja danych",
              },
              {
                icon: Activity,
                label: "Stały podgląd operacyjny",
                value: "Kalendarz, zasoby, blokady i raporty",
              },
              {
                icon: CreditCard,
                label: "Monetyzacja systemu",
                value: "Subskrypcje miesięczne i roczne",
              },
              {
                icon: Users,
                label: "Obsługa klientów",
                value: "Rezerwacje online i płatności",
              },
            ].map((item) => {
            ...
            <div className="mt-14 grid gap-5 lg:grid-cols-4">
              {[
                [
                  "1",
                  "Poznaj system",
                  "Właściciel strzelnicy widzi korzyści, funkcje i przykładowe ekrany systemu.",
                ],
                [
                  "2",
                  "Umów demo",
                  "Zostawia dane kontaktowe i wybiera prezentację platformy.",
                ],
                [
                  "3",
                  "Wybierz plan",
                  "Porównuje abonamenty i decyduje o zakresie wdrożenia.",
                ],
                [
                  "4",
                  "Uruchom obiekt",
                  "Otrzymuje dostęp i zaczyna obsługiwać rezerwacje online.",
                ],
              ].map(([step, title, desc]) => (
                <div
                  key={step}
                  className="rounded-[28px] border border-zinc-800 bg-zinc-900/70 p-6 shadow-sm"
                >
                    ...
                    <div key={feature} className="flex items-start gap-3">
                      ...
                      <span
                        className={`text-sm leading-6 ${
                          plan.highlighted ? "text-zinc-200" : "text-zinc-300"
                        }`}
                      >
                        {feature}
                      </span>
        ...
        <section
          id="kontakt"
          className="border-y border-zinc-900 bg-[linear-gradient(180deg,#0f120f,#090a09)] text-white"
        >
          <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 md:px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8 md:py-24">
            <div>
              ...
              <h2 className="mt-4 text-4xl font-semibold tracking-tight md:text-5xl">
                Pokażmy Ci system w praktyce
              </h2>
              <p className="mt-5 max-w-2xl text-lg leading-8 text-zinc-400">
                Umów prezentację i zobacz realny przepływ: od strony głównej, przez
                panel klienta, aż po zarządzanie torami, bronią i subskrypcjami w
                jednej platformie.
              </p>
            ...
            <div className="rounded-[32px] border border-zinc-800 bg-zinc-950 p-6 text-zinc-100 shadow-[0_0_80px_rgba(0,0,0,0.35)]">
              ...
              <p className="mt-2 text-sm leading-6 text-zinc-500">
                Zostaw dane, a wrócimy z propozycją prezentacji i doborem planu.
              </p>
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                <input
                  ...
                  className="w-full rounded-2xl border border-zinc-800 bg-zinc-900 px-4 py-3 text-zinc-100 outline-none placeholder:text-zinc-600 focus:border-amber-500/40"
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full rounded-2xl border border-zinc-800 bg-zinc-900 px-4 py-3 text-zinc-100 outline-none focus:border-amber-500/40"
                >
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="min-h-[140px] w-full rounded-2xl border border-zinc-800 bg-zinc-900 px-4 py-3 text-zinc-100 outline-none placeholder:text-zinc-600 focus:border-amber-500/40"
                  placeholder="Napisz kilka słów o swojej strzelnicy i potrzebach"
                  required
                />
                ...
                <button
                  ...
                  className="w-full rounded-2xl bg-amber-500 px-5 py-3 text-sm font-medium text-zinc-950 transition hover:bg-amber-400 disabled:cursor-not-allowed disabled:opacity-70"
                >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-zinc-500">
                Landing page i platforma SaaS dla strzelnic
              </div>
            </div>
          </div>
